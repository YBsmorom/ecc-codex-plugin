...
const ADAPTER_RECORDS = Object.freeze([
  ...
  },
  {
    ...
    unsupported_surfaces: ['Claude true async hook execution and slash-command semantics are not equivalent in Codex'],
    install_or_onramp: [
    ...
    risk_notes: ['Codex hooks must contain no `async` declarations; former async behavior is bounded and fail-open, not true background execution.'],
